...
import 'package:baby/sign_up_staff/bott.dart';
import 'package:baby/sign_up_staff/draw.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:intl/intl.dart';
import 'package:baby/log_in/languge.dart';

class DailyActivity_Page extends StatefulWidget {
  const DailyActivity_Page({Key? key}) : super(key: key);

  @override
  _DailyActivityPageState createState() => _DailyActivityPageState();
}

class _DailyActivityPageState extends State<DailyActivity_Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Shared_BottomAppBar(
        selectedIndex: 0,
  ...
  void _handleBottomNavigation(int index) {
    switch (index) {
      case 0:
        ...
        break;
      case 2:
        Navigator.pushNamed(context, '/pain_tracking');
        break;
      case 3:
        Navigator.pushNamed(context, '/profille');
        break;
    }
  }
