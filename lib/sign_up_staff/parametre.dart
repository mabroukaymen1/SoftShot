...
class Parameter_Screen extends StatefulWidget {
  const Parameter_Screen(
...
class _ParameterScreenState extends State<Parameter_Screen> {
            ...
            children: [
              ...
              _buildSection('Profile', [
                _buildSettingTile(
                  ...
                  icon: Icons.person,
                  onTap: () =>
                      _navigateToScreen(context, const Profile_Screen()),
                ),
                _buildSettingTile(
                  title: 'Notifications',
            ...
            TextButton(
              onPressed: () async {
                ...
                Navigator.of(context)
                    .pushReplacementNamed('/loginn'); // Adjust as needed
              },
